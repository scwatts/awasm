...
void writeSeqName(char*seq_name, SequencesWriter *seqWriteInfo, Category cat, IDnum *sequenceIndex)
{
	char name[5001];
	if (isCreateBinary()) {
...
void writeSequence(char*seq, SequencesWriter *seqWriteInfo)
{
	char str[100];
...
void initFastX(SequencesWriter *seqWriteInfo, Category cat)
{
...
void cleanupFastX(SequencesWriter *seqWriteInfo, Category cat)
{
